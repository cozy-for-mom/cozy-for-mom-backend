...
import static com.juju.cozyformombackend3.domain.communitylog.comment.model.QComment.comment;
import static com.juju.cozyformombackend3.domain.communitylog.cozylog.model.QCozyLog.cozyLog;
import static com.juju.cozyformombackend3.domain.communitylog.cozylog.model.QCozyLogImage.cozyLogImage;
import static com.juju.cozyformombackend3.domain.communitylog.scrap.model.QScrap.scrap;
...
public class CustomCozyLogRepositoryImpl implements CustomCozyLogRepository {
    ...
    public List<CozyLogSummary> searchCozyLogListByCondition(CozyLogCondition condition) {
        ...
        return jpaQueryFactory.select(new QCozyLogSummary(
                ...
                .where(searchByKeyword(condition.getKeyword())
                        .and(filterLogByWriterId(condition.getWriterId()))
                        .and(allowPrivateModeByUserId(condition.getUserId()))
