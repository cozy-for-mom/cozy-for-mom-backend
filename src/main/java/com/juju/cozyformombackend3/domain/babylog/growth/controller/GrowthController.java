            ...
            requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    content = @Content(
                            examples = {
                                    @ExampleObject(
                                            name = "someExample1",
                                            value = "{\"babyProfileId\":1,\"date\":\"2023-10-14\",\"growthImageUrl\":\"skjfhalskjdhfaslkjfhlk\",\"title\":\"제목\",\"content\":\"오늘 아롱이랑 다롱이를 보고왔는데 너무 예뻤어 선생님이 너무 잘 움직이고 있대 아프지 말고 무럭무럭 자라라\",\"babies\":[{\"babyId\":1,\"growthInfo\":{\"weight\":148.5,\"headDiameter\":3.4,\"headCircum\":12.4,\"abdomenCircum\":11.11,\"thighLength\":2.3}},{\"babyId\":2,\"growthInfo\":{\"weight\":148.5,\"headDiameter\":3.4,\"headCircum\":12.4,\"abdomenCircum\":11.11,\"thighLength\":2.3}}]}"
                                    )}
                    )
            ),
            responses = {
