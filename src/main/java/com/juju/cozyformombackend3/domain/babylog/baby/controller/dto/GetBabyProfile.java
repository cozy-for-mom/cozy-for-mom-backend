...
public class GetBabyProfile {
    ...
    public static class Response {
        ...
        public static Response of(BabyProfile foundBabyProfile) {
            ...
            return Response.builder()
                ...
                .dueAt(DateParser.localDateToStringFormatDate(foundBabyProfile.getDueAt()))
