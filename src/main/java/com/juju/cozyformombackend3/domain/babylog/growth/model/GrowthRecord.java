...
public class GrowthRecord {
    ...
    private GrowthRecord(Baby baby, Double weight, Double headDiameter, Double headCircum,
    ...
    public static GrowthRecord of(Baby baby, LocalDate recordAt, Double weight, Double headDiameter, Double headCircum,
        Double abdomenCircum, Double thighLength) {
        return new GrowthRecord(baby, weight, headDiameter, headCircum, abdomenCircum, thighLength);
    }
