...
public class FindMyInfo {
    ...
    public static class Response {
        ...
        public static Response of(UserSummary summary) {
            Response response = new Response(summary.getName(), summary.getNickname(),
        ...
        private static class BabyProfileDto {
            ...
            public static BabyProfileDto of(
                BabyProfile profile) {
                BabyProfileDto dto = new BabyProfileDto(profile.getId(), profile.getImageUrl());
                profile.getBabyList().forEach(baby -> dto.babies.add(
                    BabyDto.of(baby.getId(), baby.getName())));
